import 'package:dart_enhanced_enum_for_user_roles/dart_enhanced_enum_for_user_roles.dart';
import 'package:test/test.dart';

void main() {
  test('UserRole enum permissions property returns correct permissions', () {
    expect(UserRole.Admin.permissions, containsAll(['create', 'edit', 'delete', 'view']));
